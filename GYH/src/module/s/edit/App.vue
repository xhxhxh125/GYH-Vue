                  ...
                  <div class="widget-body no-padding">
                    <div id="base_form" class="smart-form">
                      ...
                      <fieldset>
                        <div class="row">
                          <section class="col col-8">
                            <ElSerCategory :required="true" :category="category_code" @categoryChanged="categoryChanged"></ElSerCategory>
                          </section>
                          <section class="col col-4">
                            <label class="label">&nbsp;</label>
                            <label class="input">
                              <a href="javascript:void(0);" @click="createNewService()" class="bope col-sm-6 btn btn-primary pull-left">
                                <i class="fa fa-plus"></i> 新建服务</a>
                              <a v-if="edit_mode=='edit' && functionlist.indexOf('copy@information_service_edit')>=0" href="javascript:void(0);" @click="copyService()"
                                class="bope col-sm-6 btn bg-color-orange txt-color-white pull-left">
                                <i class="fa fa-files-o"></i> 复制本服务</a>
                            </label>
                          </section>
                        </div>
                      </fieldset>
                      ...
                      <fieldset>
                        <div class="row">
                          <section class="col col-sm-12">
                            ...
                            <label class="input">
                              <input type="text" id="name" name="text" v-model="serviceInfo.core.service_name">
                            </label>
                          </section>
                        </div>
                      </fieldset>
                      ...
                      <fieldset>
                        <div class="row">
                          <section class="col col-sm-12">
                            <label class="label">服务标签</label>
                            <label class="input">
                              <input type="text" name="text" v-model="serviceInfo.core.tags" placeholder="多个标签之间以逗号隔开">
                            </label>
                          </section>
                        </div>
                      </fieldset>
                      ...
                      <fieldset>
                        <div class="row">
                          <section class="col col-sm-12">
                            <label class="label">服务图片</label>
                            <div class="textarea">
                              <div class="superbox col-sm-12">
                                <div class="superbox-list imgbox" :class="selectedPic==pic?'active':''" v-for="(pic,index) in serviceInfo.picture_list" :key="index">
                                  <img :src="appsettings.serimg+pic.oid+pic.file_type" :data-img="appsettings.serimg+pic.oid+pic.file_type" class="superbox-img">
                                  <i class="fa fa-times ibtn" style="color: red;" @click="deleteServicePic(pic,index,'list')"></i>
                                </div>

                                <div class="superbox-list imgbox" v-for="(pic,index) in serviceInfo.updatePics" :key="index" v-show="serviceInfo.updatePics!=null">
                                  <img :src="pic.base64" :data-img="pic.base64" class="superbox-img">
                                  <i class="fa fa-times ibtn" style="color: red;" @click="deleteServicePic(pic,index,'update')"></i>
                                </div>

                                <div class="superbox-list" style="text-align:center;" @click="chooseLocalPicture()">
                                  <!-- <img :src="appsettings.gyhImgPrefix+'add.png'" class="superbox-img" style="width: auto;" title="上传新的服务图片"> -->
                                  <i class="fa  fa-plus-circle" style="color: #2196F3;font-size: 50px;cursor:pointer;" title="上传新的服务图片"></i>
                                </div>
                                <!-- <div v-if="selectedPic!=null" class="superbox-show" :style="selectedPic!=null?' display: block;':' display: none;'">
																	<img :src="selectedPic.base64!=undefined && selectedPic.base64!=null?selectedPic.base64:(appsettings.serimg+selectedPic.oid+selectedPic.file_type)" class="superbox-current-img">
																	<div id="imgInfoBox" class="superbox-imageinfo inline-block" :src="selectedPic.base64!=undefined && selectedPic.base64!=null?selectedPic.base64:(appsettings.serimg+selectedPic.oid+selectedPic.file_type)"> 
																		<h1></h1><span><p><em>图片名称:{{selectedPic.file_name}}</em></p>
																		<p class="superbox-img-description"></p>
																		<p><a href="javascript:void(0);" class="btn btn-danger btn-sm" title="删除该服务图片" @click="deleteServicePic(selectedPic)">
                      ...
                      <fieldset>
                        <div class="row">
                          <section class="col col-sm-12">
                           <ElProCategory :category="serviceInfo.core.pro_category" @categoryChanged="proCategoryChanged"></ElProCategory>
                          </section>
                        </div>
                      ...
                      <fieldset>
                        <div class="row">
                          <section class="col col-sm-12">
                            ...
                            <div class="textarea">
                              <ElUEditor id="ueditor_desc" ref="ueditor_desc" :code="'2'"></ElUEditor>
                            </div>
                          </section>
                        </div>
                      </fieldset>
                ...
                <div>
                  ...
                  <div class="widget-body no-padding">
                    <table id="datatable_tabletools1" class="table table-striped table-bordered table-hover" width="100%">
                      ...
                      <tbody>
                        <tr>
                          <tr v-for="(f,index) in serviceInfo.attachment_list" :key="index">
                            <td>{{index+1}}</td>
                            <td>
                              {{f.file_name}}
                            </td>
                          ...
                          <tr v-for="(uploading_file,index) in uploading_files" :key="index" v-if="uploading_file.ok!==true">
                            <td>{{serviceInfo.attachment_list.length+index+1-uploading_ok_count}}</td>
                            <td>
                ...
                <div>
                  ...
                  <div class="widget-body no-padding" style="min-height:0;">
                    <form id="query-form" class="smart-form">
                      <footer>
                        <!-- <a target="_blank" :href="appsettings.portal_root+'service/oneservice.aspx?id='+service_oid" class="btn btn-primary pull-left"
                          :disabled="service_oid==null">
                          <i class="fa fa-eye"></i> 预览服务</a> -->

                        <!-- <a href="javascript:void(0);" class="btn btn-warning pull-left" @click="publishService()" :disabled="service_oid==null">
														<i class="fa fa-check"></i> 发布服务</a> -->
                        <button class="btn btn-warning pull-left"
                          @click="editProjects()" :disabled="service_oid==null">
                          <i class="fa fa-envira"></i> 维护服务案例</button>
...
export default {
  ...
  watch: {
    ...
    category_code: function(newVal, oldVal) {
      ...
      if (this.edit_mode == "new") {
        ...
        $.post_json(
          appsettings.apiroot + "service/category/parameter/retrieve",
          data,
        ...
        var data = {};
        data.category_code = this.category_code;
        data.service_oid = this.service_oid;
        $.post_json(
          appsettings.apiroot + "home/service/paramvalues/retrieve",
          data,
          this.callback_getParas
        );
      }
  ...
  computed: {
    edit_mode: function() {
      if (
        this.service_oid != "" &&
        this.service_oid != null &&
        this.service_oid != undefined
      ) {
        return "edit";
      } else if (
  ...
  created: function() {
    ...
    this.serviceInfo.core.company_name = $.getUrlParam("cn");
    this.serviceInfo.core.company_oid = $.getUrlParam("com");
    this.service_oid = $.getUrlParam("id");
    this.copy_source_oid = $.getUrlParam("spid");
    this.action_result = $.getUrlParam("a");

    this.init_cat = this.category_code;
    this.serviceInfo.core.category = this.category_code;
    this.serviceInfo.core.oid = this.service_oid;

    // $.post_json(
    //   appsettings.apiroot_v2 + "account/userfunction_v2", {
    //     pageid: "information_service_edit"
    //   },
    ...
    if (this.edit_mode == "new") {
      ...
      //do copy
      var copydata = {};
      copydata.service_oid = this.copy_source_oid;
      $.post_json(
        appsettings.apiroot + "service/copy",
        copydata,
        this.callback_copyService
      );
    }
    //get professions
    $.post_json(
  ...
  mounted: function() {
    ...
    if (this.edit_mode == "edit") {
      ...
      this.$refs.loading.showLoading("正在复制服务信息....");
    }
  ...
  methods: {
    getParaDef: function() {
      ...
      data.category_code = this.category_code;
      $.post_json(
        appsettings.apiroot + "service/category/paramvalues/retrieve",
        data,
        this.callback_getParas
      );
    },
    ...
    editProjects: function() {
      var pro = this.serviceInfo.core;
      if (pro != null) {
        window.open(
          "/prj/query.html?t=s&c=" +
            pro.category +
            "&id=" +
            pro.oid +
            "&com=" +
    ...
    companyChanged: function(company) {
      this.serviceInfo.core.company_oid = company.id;
      this.serviceInfo.core.company_name = company.company_name;
    },
    ...
    deleteServicePic: function(pic, index, type) {
      pic.type = type;
      var pic_index = index;
      var self = this;
      //是否确定要删除图片
      ...
      //   only_alert: false,
      //   action_code: "deleteP",
      //   title: '删除服务图片【点击"保存基本信息"按钮后才生效】',
      //   msg: "确定要删除服务图片【" + pic.file_name + pic.file_type + "】吗？",
      //   success: function(res) {
      //     if (res.confirm == true) {
      //       if (pic.type == "list") {
      //         //原图片列表
      //         self.serviceInfo.delPics_oid.push(pic.oid);
      //         self.serviceInfo.picture_list.splice(pic_index, 1);
      //         self.serviceInfo.picture_list = self.serviceInfo.picture_list;
      //       } else if (pic.type == "update") {
      //         //新加的图片
      //         self.serviceInfo.updatePics.splice(pic_index, 1);
      //         self.serviceInfo.updatePics = self.serviceInfo.updatePics;
      //       }
    ...
    createNewService: function() {
      window.location.href = "/s/edit.html?c=" + this.category_code;
    },
    copyService: function() {
      if (this.edit_mode == "new") {
        this.$refs.pf.showToast("error", "新建服务时，无法复制服务!", "");
        return;
      }
      var newurl = window.location.href
        .replace("&id=" + this.service_oid, "&spid=" + this.service_oid)
        .replace("?id=" + this.service_oid, "?spid=" + this.service_oid);
    ...
    getServiceInfo: function() {
      ...
      //get attachments
      $.post_json(
        appsettings.apiroot + "home/service/attachment/retrieve",
        data,
        this.callback_getAttachments
      );
      //get pictures
      $.post_json(
        appsettings.apiroot + "home/service/picture/retrieve",
        data,
        this.callback_getPictures
      );
    },
    callback_copyService: function(result) {
      if (result != null && result.status == 0) {
        //success
        this.$refs.loading.showLoading("服务复制成功，正在更新数据....");
        this.service_oid = result.data;
        //change url
        var newurl =
        ...
        this.$refs.pf.showToast("error", "复制服务出现异常", "");
      }
    },
    checkProfession: function(prof) {
      if (
        this.serviceInfo.core.profession != null &&
        this.serviceInfo.core.profession.length > 0
      ) {
        var codes = this.serviceInfo.core.profession.split(",");
        for (var i = 0; i < codes.length; i++) {
    ...
    proCategoryChanged: function(cat) {
      this.serviceInfo.core.pro_category = cat;
    },
    callback_getPictures: function(result) {
      if (result != null && result.status == 0) {
        this.serviceInfo.picture_list = result.data;
      } else {
        this.$refs.pf.showToast("error", "查询服务图片列表出现异常", "");
      }
    },
    callback_getAttachments: function(result) {
      if (result != null && result.status == 0) {
        this.serviceInfo.attachment_list = result.data;
      } else {
        this.$refs.pf.showToast("error", "查询服务附件列表出现异常", "");
      }
    },
      ...
      if (result != null && result.status == 0) {
        ...
        jQuery(".typeahead_1").typeahead({
          ...
          updater: function(item) {
            self.serviceInfo.core.company_oid = item.oid;
            self.serviceInfo.core.company_name = item.company_name;
          }
        });
      } else {
    ...
    profChanged: function(code, event) {
      if (event.currentTarget.checked) {
        //add  prof
        this.serviceInfo.core.profession += "," + code;
      } else {
        //remove prof
        var codes = this.serviceInfo.core.profession.split(",");
        codes.removeByValue(code);
        this.serviceInfo.core.profession = codes.join(",");
      }
    },
    publishService: function() {
      ...
      data.service_oid = this.service_oid;
      $.post_json(
        appsettings.apiroot + "service/pass",
        data,
        this.callback_publishService
      );
      this.$refs.loading.showLoading("正在发布服务...");
    },
    callback_publishService: function(result) {
      this.$refs.loading.hideLoading();
      if (result != null && result.status == 0) {
        this.$refs.confirmDlg.confirmShow({
          title: "发布成功",
          msg:
            "您已成功发布服务【" + this.serviceInfo.core.service_name + "】.",
          only_alert: true
        });
      } else {
        //failed
        this.$refs.confirmDlg.confirmShow({
          ...
          msg:
            "发布服务【" +
            this.serviceInfo.core.service_name +
            "】失败! 原因:" +
            result.message,
          only_alert: true
        });
      ...
      this.$refs.confirmDlg.confirmShow({
        ...
        success: function(res) {
          if (res.confirm == true) {
            //do delete
            $.post_json(
              appsettings.apiroot + "home/service/attachment/delete",
              attach,
    ...
    callback_deleteAtttachment: function(result, attach_index) {
      if (result != null && result.status == 0) {
        this.serviceInfo.attachment_list.splice(attach_index, 1);
      } else {
        //删除失败
        this.$refs.pf.showToast("error", "删除服务附件失败", result.message);
      }
    },
    changeRource: function(code, event) {
      if (event.currentTarget.checked) {
        this.serviceInfo.core.service_source = code;
      }
    },
    ...
    setContent: function(para) {
      ...
      var innerFunc = function(param) {
        var uename = param.ueditor_name || "ueditor_" + param.column_id;
        if (
    ...
    callback_getCoreInfo: function(result) {
      ...
      if (result != null && result.status == 0) {
        ...
        this.serviceInfo.core = result.data;
        this.category_code = this.serviceInfo.core.category;

        this.setContent({
          value: this.serviceInfo.core.description,
          ueditor_name: "ueditor_desc"
        });
      } else {
        this.$refs.pf.showToast(
          "error",
    ...
    callback_getAllValues: function(result) {
      if (result != null && result.status == 0) {
        ...
        this.serviceInfo.core = fullProInfo.service.core;
        this.serviceInfo.picture_list = fullProInfo.service.picture_list;
        this.serviceInfo.category_stack = fullProInfo.service.category_stack;

        if (
          this.serviceInfo.category_stack != null &&
          this.serviceInfo.category_stack instanceof Array &&
          this.serviceInfo.category_stack.length > 0
        ) {
          this.serviceInfo.category_name = this.serviceInfo.category_stack[
            this.serviceInfo.category_stack.length - 1
          ].name;
        }
        if (this.serviceInfo.core.highlight != null) {
          this.serviceInfo.core.highlight = this.serviceInfo.core.highlight
            .replace(/<br\/>/g, "\n")
            .replace(/<br( )*\/>/g, "\n")
            .replace(/<br(	)*\/>/g, "\n");
        }
        ...
        var self = this;
        setTimeout(function() {
          self.$refs.ueditor.setUEContent(self.serviceInfo.core.description);
        }, 200);

        var parameter_groups = fullProInfo.service.parameter_groups;
        ...
        //file list
        this.serviceInfo.attachment_list = this.serviceInfo.attachment_list
          .concat(result.data.service.attachment_pic_list)
          .concat(result.data.service.attachment_doc_list);
      } else {
        //failed
      }
    },
    ...
    queryRefPara: function() {
      ...
      $.post_json(
        appsettings.apiroot + "service/parameter/reference/retrieve",
        data,
    ...
    saveParas: function() {
      ...
      $.post_json(
        appsettings.apiroot + "home/service/paramvalues/update",
        data,
        this.callback_saveParas
      );
      this.$refs.loading.showLoading("正在保存服务参数信息...");
    },
    ...
    editRefParameter: function(para) {
      ...
      $.post_json(
        appsettings.apiroot + "service/parameter/reference/init",
        data,
    ...
    saveBasicInfo: function() {
      if ((this.category_code || "") == "") {
        this.$refs.pf.showToast("error", "服务类别不能为空", "");
        return;
      }
      if ((this.category_code || "").length < 4) {
        this.$refs.pf.showToast("error", "二级服务类别都必须选择", "");
        return;
      }
      if ((this.serviceInfo.core.service_name || "") == "") {
        this.$refs.pf.showToast("error", "服务名称不能为空", "");
        return;
      }

      this.basicInfoSuc = false;
      this.serviceInfo.core.description = this.$refs.ueditor_desc.getUEContent();
      this.serviceInfo.core.category = this.category_code;
      this.serviceInfo.core.oid = this.service_oid;

      this.serviceInfo.core.tags = (this.serviceInfo.core.tags || "").replace(
        "，",
        ","
      );
      ...
      if (this.edit_mode == "new") {
        $.post_json(
          appsettings.apiroot + "home/service/create",
          this.serviceInfo,
          this.callback_saveBasicInfo
        );
      } else {
        $.post_json(
          appsettings.apiroot + "home/service/update",
          this.serviceInfo,
          this.callback_saveBasicInfo
        );
      }
    ...
    callback_saveBasicInfo: function(result) {
      ...
      if (result != null && result.status == 0) {
        ...
        if (this.edit_mode == "new") {
          this.serviceInfo.core.oid = result.data;
          this.service_oid = result.data;
    ...
    persistAttachment: function(file) {
      this.serviceInfo.attachment_list.push(file);
      this.uploading_files[file.index].ok = true; // = this.uploading_files.splice(filedata.index, 1);
      this.uploading_ok_count++;

      // this.serviceInfo.attachment_list.push(filedadta);
      // $.post_json(
      //   appsettings.apiroot + "home/service/attachment/create",
      //   filedadta,
    ...
    InitUploader: function() {
      ...
      this.uploader = WebUploader.create({
        ...
        // 文件接收服务端。
        server: appsettings.apiroot + "home/service/attachment/upload",
        chunked: true,
        threads: 1,
        auto: true,
        fromData: {
      ...
      this.uploader.on("fileQueued", function(file) {
        ...
        self.uploader.options.formData.pid = self.service_oid;
    ...
    readFile: function() {
      ...
      reader.onload = function(e) {
        ...
        $.post_json(
          appsettings.apiroot + "home/service/picture/upload2",
          data,
    ...
    callback_persistAttachment: function(result, filedata) {
      if (result != null && result.status == 0) {
        ...
        this.serviceInfo.attachment_list.push(filedata);
    ...
    callback_uploadPicture: function(result, file) {
      if (result != null && result.status == 0) {
        ...
        pic.service_oid = this.service_oid;
        ...
        pic.description = "";
        //上传成功后存入持久化数据
        this.serviceInfo.updatePics.push(pic);
        // $.post_json(
        //   appsettings.apiroot + "service/picture/create",
        //   pic,
