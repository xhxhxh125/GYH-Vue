						...
						<div class="row">
								...
								<div class="h-100 g-brd-around g-brd-gray-light-v7 g-rounded-4 g-pa-15 g-pa-20--md">
									...
									<section>
										<ul class="list-unstyled mb-0">
											...
											<li class="g-brd-top g-brd-gray-light-v7 mb-0">
												<a class="d-flex align-items-center u-link-v5 g-parent g-py-15 active" href="/c/edit_info.html">
													<span class="g-font-size-18 g-color-gray-light-v6 g-color-primary--parent-hover g-color-primary--parent-active g-mr-15">
							...
							<div class="col-md-9">
								...
								<div class="g-pos-rel h-100 g-brd-around g-brd-gray-light-v7 g-rounded-4 g-pa-15 g-pa-30--md">
									<header>
										<h2 class="text-uppercase g-font-size-12 g-font-size-default--md g-color-black mb-0">联系信息</h2>
									</header>
									...
									<div class="row g-mb-20">
										...
										<section class="d-flex">
												<div class="col-md-4" style="padding-left:0;">
													<label class="select">
														<select :value="company_detail.country" @change="onCountryChange($event)" class="form-control h-100 form-control-md g-brd-gray-light-v7 g-brd-lightblue-v3--focus g-brd-primary--error g-rounded-4 g-px-20 g-py-12">
															<option disabled value="00">国家</option>
															<option v-for="(item,index) of countries" :value="item.enum_code" :key="index">{{item.enum_name}}</option>
														</select>
														<i></i>
													</label>
												</div>
												...
												<div class="col-md-4" style="padding-left:0;">
													<label class="select">
														<select :value="company_detail.contact_zip" @change="onCityChange($event)" class="chosen-select form-control h-100 form-control-md g-brd-gray-light-v7 g-brd-lightblue-v3--focus g-brd-primary--error g-rounded-4 g-px-20 g-py-12">
										...
										<div class="col-md-10 align-self-center">
											<div class="form-group g-pos-rel mb-0">
												...
												<input id="lastName" name="lastName" class="form-control h-100 form-control-md g-brd-gray-light-v7 g-brd-lightblue-v3--focus g-brd-primary--error g-rounded-4 g-px-20 g-py-12"
												 type="text" placeholder="详细地址" v-model="company_detail.contact_address">
											</div>
										</div>
									</div>
									...
									<div class="row g-mb-20">
										...
										<div class="col-md-10 align-self-center">
											<div class="form-group g-pos-rel mb-0">
												...
												<input id="lastName" name="lastName" class="form-control h-100 form-control-md g-brd-gray-light-v7 g-brd-lightblue-v3--focus g-brd-primary--error g-rounded-4 g-px-20 g-py-12"
												 type="text" placeholder="邮编" v-model="company_detail.contact_postcode">
											</div>
										</div>
									</div>
									...
									<div class="row g-mb-20">
										...
										<div class="col-md-10 align-self-center">
											<div class="form-group g-pos-rel mb-0">
												...
												<input id="lastName" name="lastName" class="form-control h-100 form-control-md g-brd-gray-light-v7 g-brd-lightblue-v3--focus g-brd-primary--error g-rounded-4 g-px-20 g-py-12"
												 type="text" placeholder="联系电话" v-model="company_detail.contact_phone">
											</div>
										</div>
									</div>
									...
									<div class="row g-mb-20">
										...
										<div class="col-md-10 align-self-center">
											<div class="form-group g-pos-rel mb-0">
												...
												<input id="lastName" name="lastName" class="form-control h-100 form-control-md g-brd-gray-light-v7 g-brd-lightblue-v3--focus g-brd-primary--error g-rounded-4 g-px-20 g-py-12"
												 type="text" placeholder="传真" v-model="company_detail.contact_fax">
											</div>
										</div>
									</div>
									...
									<div class="row g-mb-20">
										...
										<div class="col-md-10 align-self-center">
											<div class="form-group g-pos-rel mb-0">
												...
												<input id="lastName" name="lastName" class="form-control h-100 form-control-md g-brd-gray-light-v7 g-brd-lightblue-v3--focus g-brd-primary--error g-rounded-4 g-px-20 g-py-12"
												 type="text" placeholder="电子邮箱" v-model="company_detail.contact_email">
											</div>
										</div>
									</div>
									...
									<div class="row g-mb-20">
										...
										<div class="col-md-10 align-self-center">
											<div class="form-group g-pos-rel mb-0">
												...
												<input id="lastName" name="lastName" class="form-control h-100 form-control-md g-brd-gray-light-v7 g-brd-lightblue-v3--focus g-brd-primary--error g-rounded-4 g-px-20 g-py-12"
												 type="text" placeholder="公司网址" v-model="company_detail.contact_website">
											</div>
										</div>
									</div>

									<div class="g-mt-50">
										<a class="btn btn-xl u-btn-secondary g-font-size-default g-px-40" href="javascript:void(0);" @click="saveCompanyDetail">提交</a>
									</div>
