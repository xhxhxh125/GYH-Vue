	...
	<div id="app">
		...
		<header id="header">
			...
			<span id="extr-page-header-space">
				<span class="hidden-mobile hidden-xs">已经有账号了?</span>
				<a :href="appsettings.login_url" class="btn btn-danger">登录</a>
			</span>
                  ...
                  在科研领域，院、所现拥有专业齐全的研究方向、结构合理的教学科研队伍和配套先进的试验设备。多年来，紧密围绕国防科技工业发展对可靠性工程的专业需求，开展管理支持、人才培养、科学研究和工程服务。“九五”以来，先后承担完成了500余项科研项目，获得了包括国家科技进步特等奖在内的各类科技成果奖100余项，取得显著的经济效益和社会效益。
					...
					<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
						<div class="well no-padding">
							...
							<form id="register-form" class="smart-form client-form">
								<header>
									注册
								</header>
								...
								<fieldset>	
									...
									<section>
										<label class="input">
											...
											<input type="text" name="mobile" placeholder="手机号" v-model="user_mobile">
											<b class="tooltip tooltip-bottom-right">请输入手机号</b>
										</label>
									</section>
									...
									<section>
										<label class="input">
											...
											<input type="email" name="email" placeholder="Email" v-model="user_email">
											<b class="tooltip tooltip-bottom-right">请输入电子邮箱</b>
										</label>
									</section>
									...
									<section>
										<label class="input">
											...
											<input type="password" name="password" placeholder="密码" id="password" v-model="user_password">
									...
									<section>
										<label class="checkbox">
											...
											<i></i>阅读并同意
											<a href="#" data-toggle="modal" data-target="#myModal"> 条款 </a>
										</label>
									</section>
								</fieldset>
...
export default {
	...
	methods: {
		Register: function() {
			if(validator.form()){
				var data = { user_email: this.user_email, user_mobile: this.user_mobile, user_password: this.user_password, validate_code: this.validate_code };
				$.post_json(appsettings.apiroot + "account/cidepregister", data, this.callback_register);
			}
		},
		callback_register: function(result) {
