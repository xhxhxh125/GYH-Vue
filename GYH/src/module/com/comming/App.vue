						...
						<div class="row">
							<div class="col-sm-12">
								<div class="text-center error-box">
									<h1 class="error-text-2 bounceInDown animated"> 网页建设中 <span class="particle particle--c"></span><span class="particle particle--a"></span><span class="particle particle--b"></span></h1>
									<h2 class="font-xl"><strong><!-- <i class="fa fa-fw fa-warning fa-lg text-warning"></i> --> coming soon</strong></h2>
									<br />
									<!-- <p class="lead">
									...
									<div class="error-search well well-lg padding-10">
										<div class="input-group">
											<input class="form-control input-lg" type="text" placeholder="搜索" v-model="keywords" id="search-error" @keyup="searchEnter">
											<a :href="'/com/search.html?keywords='+keywords" class="input-group-addon"><i class="fa fa-fw fa-lg fa-search"></i></a>
										</div>
									</div>
...
export default {
	...
	methods: {
		searchEnter:function(e){
			if(e.keyCode==13){
				window.location.href="/com/search.html?keywords="+this.keywords;
			}
		}
	},
}
