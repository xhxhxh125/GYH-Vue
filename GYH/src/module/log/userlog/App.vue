                    ...
                    <table id="datatable_tabletools" class="nowrap table table-bordered">
                      ...
                      <tbody>
                        <tr class="row-show" v-for="(log,index) in result_logs" :key="index">
                          ...
                          <td class="nw">{{log.user_name}}</td>
                          <td class="nw">{{log.operation_code}}</td>
                          <td class="nw">{{log.description}}</td>
  ...
  export default {
    ...
    methods: {
      ...
      queryClick: function () {
        ...
        $.post_json(
          appsettings.apiroot + "admin/log/user/retrieve",
          this.query_data,
      ...
      callback_queryClick: function (result) {
        if (result != null && result.status == 0) {
          this.result_logs = result.data.UserLogs;
