              ...
              <div class="h-100 g-brd-around g-brd-gray-light-v7 g-rounded-4 g-pa-15 g-pa-20--md">
                ...
                <div class="row g-mb-20">
                  <div class="col-md-3 align-self-center g-mb-5 g-mb-0--md">
                    <label class="mb-0" for="#currentPassword">手机号码</label>
                  </div>
                  ...
                  <div class="col-md-9 align-self-center row">
                    <div class="col-md-9">
                      <div class="form-group g-pos-rel mb-0">
                        ...
                        <input id="currentPassword" name="currentPassword" class="form-control h-100 form-control-md g-brd-gray-light-v7 g-brd-lightblue-v3--focus g-brd-primary--error g-rounded-4 g-px-20 g-py-12"
                          type="text" placeholder="手机号" v-model="userinfo.user_mobile">
                      </div>
                    </div>
                    <div class="col-md-3 align-self-center g-mb-5 g-mb-0--md">
                      <button class="obtain" for="#currentPassword"><a href="/user/edit_account_mobile.html">修改手机号码</a></button>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="col-md-9 align-self-center row">
                    <div class="col-md-9">
                      <div class="form-group g-pos-rel mb-0">
                        ...
                        <input id="currentPassword" name="currentPassword" class="form-control h-100 form-control-md g-brd-gray-light-v7 g-brd-lightblue-v3--focus g-brd-primary--error g-rounded-4 g-px-20 g-py-12"
                          type="email" placeholder="电子邮箱" v-model="userinfo.user_email">
                      </div>
                    </div>
                    <div class="col-md-3 align-self-center g-mb-5 g-mb-0--md">
                      <button class="obtain" for="#currentPassword"><a href="/user/edit_account_email.html">修改邮箱</a></button>
                    </div>
                  </div>
                </div>
              </div>
