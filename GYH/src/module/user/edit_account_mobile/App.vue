                      ...
                      <div class="col-md-9">
                        <div class="form-group g-pos-rel mb-0">
                          ...
                          <input class="form-control h-100 form-control-md g-brd-gray-light-v7 g-brd-lightblue-v3--focus g-brd-primary--error g-rounded-4 g-px-20 g-py-12"
                            name="verificationcode" placeholder="验证码" id="verificationcode" v-model="validCode" />
                        </div>
                      </div>
                      <div class="col-md-3 align-self-center g-mb-5 g-mb-0--md">
                        <ElGetValCode :account="userinfo.user_mobile" :url="appsettings.apiroot + 'message/getvalcode/mobile'"
                          @error="getValCodeError"></ElGetValCode>
                      </div>
                    </div>
                  </div>
                  <div>
                    <a class="btn btn-md btn-xl--md u-btn-secondary g-width-160--md g-font-size-12 g-font-size-default--md g-mb-10"
                      type="submit" href="javascript:void(0);" @click="saveAccountInfo">保存手机号码</a>
                  </div>
                </div>
              </div>
