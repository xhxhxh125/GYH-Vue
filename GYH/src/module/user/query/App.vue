                    ...
                    <div>
                      <div class="row g-mx-minus-10">
                        <div class="col-md align-self-center g-px-10 g-mb-20 g-mb-0--md">
                          <header>
                            <h2 class="text-uppercase g-font-size-12 g-font-size-default--md g-color-black mb-0">工业技能</h2>
                          </header>
                          ...
                          <div class="row g-mb-20">
                            <div class="col-md-12">
                              <label class="mb-0 g-mb-20" for="#currentPassword">技能和爱好</label>
                            </div>

                            <div class="col-md-12 align-self-center row">
                              <div class="col-md-6">
                                <div class="form-group g-pos-rel mb-0">
                                  <span class="g-pos-abs g-top-0 g-right-0 d-block g-width-40 h-100 opacity-0 g-opacity-1--success">
                                    <i class="hs-admin-check g-absolute-centered g-font-size-default g-color-secondary"></i>
                                  </span>
                                  <input name="currentPassword" class="form-control h-100 form-control-md g-brd-gray-light-v7 g-brd-lightblue-v3--focus g-brd-primary--error g-rounded-4 g-px-20 g-py-12"
                              ...
                              <div class="col-md-3 bootstrap-tagsinput">
                                <button class="obtain" for="#currentPassword" data-role="tagsinput">添加</button>
                              </div>
                            </div>
                          </div>
                          <div class="row g-mb-20">
                            <div class="col-md-12">
                              <label class="mb-0 g-mb-20">技能和爱好</label>
                            </div>
                            <div class="u-tagsinput--v2--blue g-brd-around g-brd-lightblue-v3--focus g-rounded-4 g-px-6">
