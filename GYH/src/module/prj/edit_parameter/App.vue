              ...
              <div class="col-md-9">
                <div class="h-100 g-brd-around g-brd-gray-light-v7 g-rounded-4 g-pa-15 g-pa-20--md">
                  ...
                  <div v-for="para in parameters" :key="para.column_id">
                    ...
                    <div class="row g-mb-20" v-if="para.data_type==3">
                      <label class="g-mb-10">{{para.is_required=='1'?'*':''}}{{para.column_name}}</label>
                      <div class="form-group mb-0">
                        <div class="textarea">
                          <input
                    ...
                    <div class="row g-mb-20" v-if="para.data_type==4">
                      <label class="g-mb-10">{{para.is_required=='1'?'*':''}}{{para.column_name}}</label>
                      <div class="form-group mb-0">
                        <div class="textarea">
                          <input
                    ...
                    <div class="row g-mb-20" v-if="para.data_type==5">
                      <label class="g-mb-10">{{para.is_required=='1'?'*':''}}{{para.column_name}}</label>
                      <div class="form-group mb-0">
                        <div class="textarea">
                          <input
                    ...
                    <div class="row g-mb-20" v-if="para.data_type==6">
                      <label class="g-mb-10">{{para.is_required=='1'?'*':''}}{{para.column_name}}</label>
                      <div class="form-group mb-0">
                        <div class="textarea">
                          <input
