                    ...
                    <ul class="list-unstyled mb-0">
                      <li class="g-brd-top g-brd-gray-light-v7 mb-0">
                        <a
                          ...
                          :href="'/prj/edit.html?id='+projectInfo.core.oid+'&c='+projectInfo.core.category_code+'&pid='+projectInfo.core.product_oid+'&sid='+projectInfo.core.service_oid+'&com='+projectInfo.core.company_oid+'&t='+subject_type"
                        >
                          <span
                      ...
                      <li class="g-brd-top g-brd-gray-light-v7 mb-0">
                        <a
                          ...
                          :href="'/prj/edit_parameter.html?id='+projectInfo.core.oid+'&c='+projectInfo.core.category_code+'&pid='+projectInfo.core.product_oid+'&sid='+projectInfo.core.service_oid+'&com='+projectInfo.core.company_oid+'&t='+subject_type"
                        >
                          <span
                            class="g-color-gray-dark-v6 g-color-primary--parent-hover g-color-primary--parent-active"
                          >案例参数信息</span>
                      ...
                      <li class="g-brd-top g-brd-gray-light-v7 mb-0">
                        <a
                          class="d-flex align-items-center u-link-v5 g-parent g-py-15"
                          :href="'/prj/edit_video.html?id='+projectInfo.core.oid+'&c='+projectInfo.core.category_code+'&pid='+projectInfo.core.product_oid+'&sid='+projectInfo.core.service_oid+'&com='+projectInfo.core.company_oid+'&t='+subject_type"
                        >
                          <span
                            class="g-color-gray-dark-v6 g-color-primary--parent-hover g-color-primary--parent-active"
                          >案例视频</span>
                      ...
                      <li class="g-brd-top g-brd-gray-light-v7 mb-0">
                        <a
                          class="d-flex align-items-center u-link-v5 g-parent g-py-15"
                          :href="'/prj/edit_img.html?id='+projectInfo.core.oid+'&c='+projectInfo.core.category_code+'&pid='+projectInfo.core.product_oid+'&sid='+projectInfo.core.service_oid+'&com='+projectInfo.core.company_oid+'&t='+subject_type"
                        >
                          <span
                            class="g-color-gray-dark-v6 g-color-primary--parent-hover g-color-primary--parent-active"
                          >案例图库</span>
                    ...
                    <div class="row g-mb-20">
                      ...
                      <div class="col-md-9 align-self-center row">
                        <div class="col-md-9 align-self-center">
                          <div class="form-group g-pos-rel mb-0">
                            ...
                            <input
                              type="text"
                              name="text"
                              v-model="projectInfo.core.project_name"
                        ...
                        <div class="col-md-3 align-self-center g-mb-5 g-mb-0--md">
                          ...
                          >{{edit_mode=="edit"?'编辑':'新增'}}案例</button>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row g-mb-20">
                      ...
                      <div class="col-md-9 align-self-center">
                        <div class="form-group g-pos-rel mb-0">
                          ...
                          <input
                            type="text"
                            v-model="projectInfo.core.key_tag"
                            class="form-control h-100 form-control-md g-brd-gray-light-v7 g-brd-lightblue-v3--focus g-brd-primary--error g-rounded-4 g-px-20 g-py-12"
                          >
                        </div>
                      </div>
                    ...
                    <div class="row g-mb-20">
                      ...
                      <div class="col-md-9 align-self-center">
                        <div class="form-group g-pos-rel mb-0">
                          ...
                          <input
                            type="text"
                            v-model="projectInfo.core.process"
                            class="form-control h-100 form-control-md g-brd-gray-light-v7 g-brd-lightblue-v3--focus g-brd-primary--error g-rounded-4 g-px-20 g-py-12"
                          >
                        </div>
                      </div>
                    ...
                    <div class="g-mb-20">
                      ...
                      <div class="form-group mb-0">
                        <div class="form-group g-mb-30">
                          <textarea
                            v-model="projectInfo.core.description"
                            class="form-control form-control-md g-resize-none g-brd-gray-light-v7 g-brd-gray-light-v3--focus rounded-0"
                            rows="10"
                              ...
                              <section class="col col-sm-12">
                                ...
                                <label class="input">
                                  <input
                                    ...
                                    name="text"
                                    disabled
                                    :value="subjectCoreInfo.subject_name"
                                  >
                                </label>
                              </section>
                            </div>
                            ...
                            <div class="row">
                              <div v-for="para in parameters" :key="para.column_id">
                                  ...
                                  <section>
                                    ...
                                    <div class="inline-group">
                                      ...
                                      >
                                        <input
                                          type="radio"
                                          @change="radioParaChanged(ch.enum_code,para,$event)"
                                          :value="ch.enum_code"
                                ...
                                <section v-if="para.data_type==9" class="col col-3">
                                  ...
                                  <label class="input">
                                    <section
                                      v-if="para.display_value!=null && para.display_value!=undefined && para.display_value.indexOf('{')>=0"
                                    >
                                      <a
                                        :href="v.href"
                                        target="_blank"
                                        class="btn pull-left"
                                        v-for="(v,ridx) in JSON.parse(para.display_value)"
                                        :key="ridx"
                                      >{{(ridx>0?",":"")+v.value}}</a>
                                    </section>
                                    <a
...
export default {
  ...
  methods: {
    getProductCoreInfo: function() {
      var data = {};
      data.oid = this.subject_oid;
      $.post_json(
        appsettings.apiroot + "home/product/core/retrieve",
        data,
        this.callback_getProductCoreInfo
      );
    },
    getServiceCoreInfo: function() {
      ...
      $.post_json(
        ...
        data,
        this.callback_getServiceCoreInfo
      );
    },
    ...
    checkProfession: function(prof) {
      if (
        this.projectInfo.core.profession != null &&
        this.projectInfo.core.profession.length > 0
      ) {
    ...
    callback_publishProject: function(result) {
      ...
      if (result != null && result.status == 0) {
        this.$refs.confirmDlg.confirmShow({
          title: "发布成功",
          msg:
            "您已成功发布案例【" + this.projectInfo.core.project_name + "】.",
          only_alert: true
        });
      } else {
        //failed
    ...
    formatParaValues: function(parameters) {
      ...
      for (var j = 0; j < parameters.length; j++) {
        ...
        if (
          ...
          var ue = this.$refs[
            "ueditor_" + parameters[j].category_code + parameters[j].column_id
          ];
    ...
    callback_saveBasicInfo: function(result) {
      ...
      if (result != null && result.status == 0) {
        ...
        if (this.edit_mode == "new") {
          ...
          $.setUrlParam("id", this.project_oid);
      ...
      this.uploader.on("uploadSuccess", function(file, response) {
        ...
        if (response != null) {
          if (response.status == 0) {
            ...
            setTimeout(() => {
              self.uploading_files = self.uploading_files.splice(
                file.index - 1,
                1
              );
            }, 0);
