...
(function ($) {
  ...
  $.HSCore.components.HSFileAttachment = {
     ...
     */
    _baseConfig: {
      changeInput: '<div class="g-parent g-pos-rel g-height-230 g-bg-gray-light-v8--hover g-brd-around g-brd-style-dashed g-brd-gray-light-v7 g-brd-lightblue-v3--hover g-rounded-4 g-transition-0_2 g-transition--ease-in g-pa-15 g-pa-30--md">\
              <div class="d-md-flex align-items-center g-absolute-centered--md w-100 g-width-auto--md">\
                ...
                <div class="text-center text-md-left g-ml-20--md">\
                  <h3 class="g-font-weight-400 g-font-size-16 g-color-black g-mb-10">上传你的文件</h3>\
                  <p class="g-font-weight-300 g-color-gray-dark-v6 mb-0">在此处拖动文件或单击“上传”按钮并从计算机中浏览。</p>\
                </div>\
              </div>\
            </div>',
      showThumbs: true,
      templates: {
        box: '<hr class="d-flex g-brd-gray-light-v7 g-my-15 g-my-25--md">\
...
(function ($) {
  ...
  $.HSCore.components.HSFileAttachvideo = {
    /**
     *
     *
     * @var Object _baseConfig
    ...
    _baseConfig: {
      ...
      templates: {
        box: '<hr class="d-flex g-brd-gray-light-v7 g-my-15 g-my-25--md">\
              <div class="js-result-list row g-mx-minus-8"></div>',
        item: '<div class="js-result-list__item col-md-12 text-center g-px-8 g-mb-15">\
	              <div class="align-items-center h-100 g-brd-around g-brd-gray-light-v7 g-rounded-2 g-pa-15">\
	                <h3 class="g-font-size-16 g-color-gray-dark-v2 g-mb-5">{{fi-name}}</h3>\
	                <div class="g-mb-10">{{fi-image}}</div>\
	              </div>\
