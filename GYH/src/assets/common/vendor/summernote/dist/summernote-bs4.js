...
$$1.extend($$1.summernote.lang, {
    'en-US': {
        ...
        image: {
            ...
            shapeNone: '形状：无',
            dragImageHere: '将图像或文本拖到此处',
            dropImage: '删除图像或文本',
            selectFromFiles: '从文件中选择',
            maximumFileSize: '最大文件大小',
            maximumFileSizeError: '超出了最大文件大小.',
            url: '图片路径',
            remove: '去除图像',
            original: '原件'
        },
        ...
        help: {
            ...
            'formatH1': '将当前块的格式更改为 H1',
            'formatH2': '将当前块的格式更改为 H2',
            'formatH3': '将当前块的格式更改为 H3',
            'formatH4': '将当前块的格式更改为 H4',
            'formatH5': '将当前块的格式更改为 H5',
            'formatH6': '将当前块的格式更改为 H6',
...
var HelpDialog = /** @class */ (function () {
    ...
    HelpDialog.prototype.initialize = function () {
        ...
        var body = [
            ...
            '<a href="https://github.com/summernote/summernote" target="_blank">项目</a> · ',
            '<a href="https://github.com/summernote/summernote/issues" target="_blank">问题</a>',
            '</p>'
        ].join('');
        this.$dialog = this.ui.dialog({
...
$$1.summernote = $$1.extend($$1.summernote, {
    ...
    options: {
        ...
        styleTags: [
            'p',
            { title: '大段引用', tag: 'blockquote', className: 'blockquote', value: 'blockquote' },
            'h1', 'h2', 'h3', 'h4', 'h5', 'h6'
        ],
        fontNames: [
